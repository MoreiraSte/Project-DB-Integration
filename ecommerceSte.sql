...
--
-- Host: 10.109.71.19    Database: stephany_moreira
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `pedido_AFTER_INSERT` AFTER INSERT ON `pedido` FOR EACH ROW BEGIN
	delete from pedido_itens where fk_pedido = new.idPe;
	insert into Info_Log values(null,now(), (select concat(new.nome_cliente , ' ', new.valor_total, ' ',new.statusPe)));
END */;;
DELIMITER ;
...
INSERT INTO `produto` VALUES (1,'doritos',8,20),(2,'TNT',9,6),(3,'coca-cola',5,10),(4,'bolo',5,70),(6,'chuchu',100,100),(7,'sucrilhos',10,16);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `produto_AFTER_INSERT` AFTER INSERT ON `produto` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `produto_BEFORE_DELETE` BEFORE DELETE ON `produto` FOR EACH ROW BEGIN
...
INSERT INTO `usuario` VALUES (1,'stephany','$2b$12$QiBieSTidll7H1z1XmiIfeDTg5Jm2dOLsGkoCecI6z3rmXnces2hC'),(2,'test','$2b$12$WdiTWjUn4w2P6YlCMjlsXeN8rEzWRS90fPK/EKA4UH3NVIw/VuhXq');
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'stephany_moreira'
--

--
-- Dumping routines for database 'stephany_moreira'
--
...
-- Dump completed on 2022-10-28 11:31:11
